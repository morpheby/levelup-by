    ...
    [Ll]inux)
        ...
        case $distro in
            ...
            Schrödinger’sCat)
                if [[ ! $noninteractive ]]; then
                    warning "
                            Fedora support is not fully debugged. Assuming you have standard
                            development packages already working like scipy, the
                            installation should go fine, but this is still a work in progress.
                ...
                ;;
            *)
                error "We hope you have git installed for your $distro"
               ;;
        esac
        ;;
...
EO
        ...
        ;;
    *)
        error "Unsupported platform. Try switching to either Mac or a Debian-based linux distribution (Ubuntu, Debian, or Mint), or maybe even RedHat based"
        exit 1
        ;;
esac
